...
Public Class frm_MixAssortRejectTransfer
    ...
    Private Sub Load_Rejects()
        ...
        rsComSql.Open("SELECT * FROM tblMixRejects WHERE Stock = 1 AND OK = 2 ORDER BY ParNo,PktNo,Assortment", AdoCN, 1, 1)
        If rsComSql.RecordCount Then
            ...
            While Not rsComSql.EOF
                ...
                If Mid(rsComSql.Fields("Assortment").Value, 1, 1) = "S" Or Mid(rsComSql.Fields("Assortment").Value, 1, 1) = "R" Or Mid(rsComSql.Fields("Assortment").Value, 7, 1) = "R" Or Mid(rsComSql.Fields("Assortment").Value, 7, 1) = "S" Then
                    strCat = "Rough"
                Else
                    strCat = "Polished"
                End If
                ...
                flxDetails.Rows.Add(rsComSql.Fields("ParNo").Value,
                                    ...
                                    strCat,
                                    rsComSql.Fields("EstCts").Value,
                                    rsComSql.Fields("EstAssort").Value)
    ...
    Private Sub Update_Assortments()
        ...
        If PBResponse = MsgBoxResult.Yes Then
            For intRow = 0 To flxDetails.Rows.Count - 1
                If flxDetails.Item(11, intRow).Value = True Then
                    ...
                    If Not IsNumeric(flxDetails.Item(4, intRow).Value) Then
                        MsgBox("Invalid Act Cts - " & flxDetails.Item(5, intRow).Value, MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
                        Exit Sub
                    End If
                    ...
                    If Not IsNumeric(flxDetails.Item(19, intRow).Value) Then
                        MsgBox("Invalid Est Cts - " & flxDetails.Item(5, intRow).Value, MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
                        Exit Sub
                    End If

                    If Len(flxDetails.Item(19, intRow).Value) = 0 Then
                        MsgBox("Invalid Est Cts - " & flxDetails.Item(5, intRow).Value, MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
                        Exit Sub
                    End If

                    If CDbl(flxDetails.Item(19, intRow).Value) < 0 Then
                        MsgBox("Invalid Est Cts - " & flxDetails.Item(5, intRow).Value, MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
                        Exit Sub
                    End If

                    If CDbl(flxDetails.Item(19, intRow).Value) > 0 Then
                        If Len(flxDetails.Item(20, intRow).Value) = 0 Then
                            MsgBox("Invalid Est Assortment - " & flxDetails.Item(5, intRow).Value, MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
                            Exit Sub
                        End If
                    End If
                End If
            ...
            For intRow = 0 To flxDetails.Rows.Count - 1
                If flxDetails.Item(11, intRow).Value = True Then
                    ...
                    'Update Assortment
                    AdoCN.Execute("UPDATE tblMixRejects SET Assortment = '" & UCase(flxDetails.Item(5, intRow).Value) & "', Cts = '" & CDbl(flxDetails.Item(4, intRow).Value) & "', " & _
                                    "EstCts = '" & CDbl(flxDetails.Item(19, intRow).Value) & "', EstAssort = '" & UCase(flxDetails.Item(20, intRow).Value) & "' " & _
                                  "WHERE ID = " & Val(flxDetails.Item(12, intRow).Value) & "")

                End If
            Next
            If blnSave = True Then
                MsgBox("Assortments Updated Successfully", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
            Else
                MsgBox("No Records to Update", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, Me.Text)
            End If
            Load_Rejects()
        End If
    End Sub
        ...
        If PBResponse = MsgBoxResult.Yes Then
            For intRow = 0 To flxDetails.Rows.Count - 1
                If flxDetails.Item(11, intRow).Value = True Then
                    ...
                    'Update Trf = 3
                    AdoCN.Execute("UPDATE tblMixRejects SET OK = 3 WHERE ID = " & Val(flxDetails.Item(12, intRow).Value) & "")
