...
Public Class frm_MixAssortUpdate
    ...
    Private Sub Load_Excel()
        ...
        If Len(Dir(txtFilePath.Text)) > 0 Then
            ...
            For intRow = 2 To 10000
                ...
                rsComSql.Open("SELECT AvgCost FROM tblAssortList WHERE Assortment = '" & Trim(xlWorkSheet.Cells(intRow, 1).Value) & "'", AdoCN, 1, 1)
                If rsComSql.RecordCount Then
                    dblPrice = rsComSql.Fields("AvgCost").Value
                End If
                rsComSql = Nothing
...
ErrorHandler:
    ...
    Private Sub Save()
        ...
        For intRow = 0 To flxDetails.Rows.Count - 1
            ...
            If rsComSql.RecordCount Then
                AdoCN.Execute("UPDATE tblAssortList SET AvgCost = " & CDbl(flxDetails.Item(1, intRow).Value) & " WHERE Assortment = '" & flxDetails.Item(0, intRow).Value & "'")
            End If
            rsComSql = Nothing
        Next
    ...
    Private Sub frm_MixAssortUpdate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
